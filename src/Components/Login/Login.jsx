...
export default function Login(props) {
  ...
  let[loading , setLoading] = useState(false);
   ...
   async function submitForm(e){
    ...
    if(validationResponse.error) {
      ...
      if(localStorageUser.email === user.email && localStorageUser.password === user.password ) {
          setLoading(false);
          let loginUser = {name:localStorageUser.first_name , email:localStorageUser.email , password:localStorageUser.password};
        ...
        setLoading(false); 
        setErrorr("Wrong Email or Password");
  ...
  return (
    ...
    Loading...
</button> :  <button type='submit' className='bg-red-700 px-[55px] py-3 text-lg rounded-lg pl-14 ' > Login </button>
 }
